...
comparison_expression:
    inter_expression  logical_cmprt  expression
    {
		...
		// Ajout des quadruplets
		strcpy(op, "-");
		strcpy(arg2, expr_val);
		strcpy(arg1, inter_expr_val);
		strcpy(rslt, new_temp());
		quadr(op, arg1, arg2, rslt);
...
D: 
	mc_DOWHILE '(' condition_statement ')' 
	{
		...
		//{
			...
			if (strcmp(comp_expr_op, "BPZ") == 0) strcpy(comp_expr_op, "BPZ");		
...
C:
	mc_IF '(' condition_statement ')' %prec IFX
	{
